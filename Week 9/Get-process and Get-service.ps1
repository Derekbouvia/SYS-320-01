...
Get-Process | Select-Object ProcessName, Path, ID | `
Export-Csv -Path "C:\Users\derek.bouvia\Desktop\processes.csv" -NoTypeInformation

Get-Service | Where-Object { $_.Status -eq "Running"} | `
Export-Csv -Path "C:\Users\derek.bouvia\Desktop\running_services.csv" -NoTypeInformation
